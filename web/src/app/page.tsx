...
export default function Home() {
  ...
  return (
    <div className="relative min-h-[500vh] text-[#F5F5F0] bg-[#000000] selection:bg-white selection:text-black cursor-none">
      ...
      {/* Hero Section */}
      <section className="relative flex h-screen items-center justify-center px-10">
      ...
      <section className="relative flex min-h-[60vh] flex-col items-center justify-center py-48 text-center px-10">
        ...
        <h2 className="font-serif text-6xl italic tracking-tighter sm:text-[10vw] text-zinc-600 leading-[0.8]">
