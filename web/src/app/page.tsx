  ...
  return (
    <div className="relative min-h-[500vh] text-[#F5F5F0] bg-[#000000] selection:bg-white selection:text-black cursor-none overflow-x-hidden">
      ...
      <section id="archive" className="relative z-10 w-full py-20 bg-black overflow-hidden px-0 sm:px-24">
        ...
        <div className="max-w-[1800px] mx-auto flex flex-col gap-[4px] md:block md:columns-4 lg:columns-6 xl:columns-8 2xl:columns-10 md:gap-4 md:space-y-4 px-[4px] md:px-0">
          {filteredPhotos.map((photo) => (
            <div key={photo.id} className="w-full md:break-inside-avoid md:mb-4">
